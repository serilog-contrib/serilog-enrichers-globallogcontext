...
Task("restore")
    ...
    .Does(() =>
{
    DotNetRestore("./serilog-enrichers-globallogcontext.sln", new DotNetRestoreSettings
    {
        LockedMode = true,
    });
});
...
{
    DotNetBuild("./serilog-enrichers-globallogcontext.sln", new DotNetBuildSettings
    {
    ...
    .Does(() =>
{
    ...
    DotNetPack("./src/Serilog.Enrichers.GlobalLogContext/Serilog.Enrichers.GlobalLogContext.csproj", new DotNetPackSettings
    {
        Configuration = "Release",
        NoRestore = true,
        NoBuild = true,
